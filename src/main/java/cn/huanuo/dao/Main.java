...
public class Main {
    ...
    {
        ct = new ClassPathXmlApplicationContext("application-jdbc.xml");
        dataSource = ct.getBean(DataSource.class);
        jdbcTemplate = (JdbcTemplate) ct.getBean("jdbcTemplate");
        namedParameterJdbcTemplate = (NamedParameterJdbcTemplate) ct.getBean("namedParameterJdbcTemplate");
